...
class _ProfilePageState extends State<ProfilePage> {
  // Data profil
  String name = 'Ismiatun';
  String bio =
      'Mahasiswa Sistem Informasi yang memiliki minat dan fokus dalam bidang Pemrograman.'
  ...
  String email = 'ismiatunjm444@gmail.com';
  String phone = '+62 895604562250';
  String birthday = '13 Agustus 2005';
                ...
                child: Stack(
                  ...
                  children: [
                    Opacity(
                      opacity: 0.9,
                      child: Image.network(
                        'https://images.unsplash.com/photo-1547756536-cde3673fa2e5?q=80&w=941&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                        fit: BoxFit.cover,
                      ),
                    ),
                    Column(
  ...
  ImageProvider _getAvatarImage() {
    if (avatarFile != null) {
      ...
      return const NetworkImage(
        'https://images.unsplash.com/photo-1576201549624-007c49da04af?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      );
    }
  }
